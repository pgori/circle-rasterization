...
/* 
  |(x - cx)² + (y - cy)² - r²| ≤ 1.0
*/
function drawFirstQuadrant(cx: number, cy: number, radius: number) {
  let x = cx;
  let y = cy;
...
function drawSecondQuadrant(cx: number, cy: number, radius: number) {
  let x = cx;
  let y = cy;
  for(let i = 0; i <= radius; i++) {
    for(let j = 0; j <= radius; j++) {
...
function drawThirdQuadrant(cx: number, cy: number, radius: number) {
  let x = cx;
  let y = cy;
  for(let i = 0; i <= radius; i++) {
    for(let j = 0; j <= radius; j++) {
...
function drawFourthQuadrant(cx: number, cy: number, radius: number) {
  let x = cx;
  let y = cy;
  for(let i = 0; i <= radius; i++) {
    for(let j = 0; j <= radius; j++) {
